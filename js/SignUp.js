function CheckThongTin() {
    ...
    var confirmPassword = document.getElementById("MatKhauLai").value;
    let k=true;
    ...
    if (confirmPassword == "" || confirmPassword != pass) {
        document.getElementById("errol_MKL").style.display='flex'
        document.getElementById("MatKhauLai").classList.add('errol')
        k=false
        
    }
    if(k){
        alert("Đăng ksi thành công")
